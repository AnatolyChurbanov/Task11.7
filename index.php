...
<html lang="en">
  ...
  <body>
    ...
    <h2><span>Задание 2. Таблица сравнения.</span></h2>
    ...
    <p>Из вышеуказанных таблиц мы можем делать вывод, что между двумя типами сравнения имеются отличия. Основным различием является то, что
